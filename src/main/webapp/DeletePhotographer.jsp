...
<body>
    ...
    <div class="container">
        ...
        <form action ="delete" method = "post">
            ...
            <input type="text" id="firstName" name="Name"  value = "<%=firstUser.getName()%>" readonly>
            
            <label for="Address">Address:</label>
            <input type="text" id="address" name="Address"  value = "<%=firstUser.getAddress()%>"readonly>

            <label for="NIC">NIC:</label>
            <input type="text" id="nic" name="NIC" value = "<%=firstUser.getNIC()%>" readonly>
            
            <label for="dob">Date of Birth:</label>
            <input type="date" id="dob" name="dob" value = "<%=firstUser.getDateofbirthday()%>" readonly>

            <label for="gender">Gender</label>
            <input type="text" id="gender" name="gender" value = "<%=firstUser.getGender()%>" readonly>
            

            <label for="email">Email:</label>
            <input type="email" id="email" name="email" value = "<%=firstUser.getEmail()%>" readonly>

            <label for="number">Phone Number:</label>
            <input type="text" id="number" name="number" value = "<%=firstUser.getContactNumber()%>" readonly>
            
            <label for="UserNameP">User Name:</label>
            <input type="text" id="UserNameP" name="UserNameP" value = "<%=firstUser.getUserNameP()%>" readonly>
